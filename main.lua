...
function ob()
    ...
    --[[Ub(CFrame.new(1128.6217, 107.905235, 1312.755))
    Ub(CFrame.new(1083.84802, 139.555054, 1314.15723) + Vector3.new(0, -5, 0))
    Ub(CFrame.new(1083.84802, 139.555054, 1314.15723) + Vector3.new(0, 5, 0))
    Ub(CFrame.new(1083.84802, 139.555054, 1314.15723) + Vector3.new(10, 5, 0))
    Main:updateButton(Status, "Museum | Teleporting to Police Station")
    TP2(CFrame.new(749.741821, 38.5034256, 1057.00269))
    wait(10)--]]
    Main:updateButton(Status, "Museum | Teleporting to Volcano Base")
    --tp(CFrame.new(2287.22876, 20.1366863, -2067.20386))
...
function Ct()
    ...
    getgenv().teleport(jc.CFrame + jc.Velocity * 2, true)
    wait(1)
...
local function Pt()
    ...
    for i,v in pairs(game:GetService("Workspace").Vehicles:GetChildren()) do
        if v:FindFirstChild("Seat") then
            if v.Seat.PlayerName.Value == game:GetService("Players").LocalPlayer.Name then
                repeat
                    getgenv().teleport(CFrame.new(2286.67114, 19.1927166, -2080.41528))
                until v.PrimaryPart.CFrame == CFrame.new(2286.67114, 19.1927166, -2080.41528)
            end
        end
    end
        Ub(CFrame.new(2216.5354, 19.3582458, -2470.72461, 0.988022506, -8.40341983e-08, 0.154309943, 8.18320629e-08, 1, 2.06226609e-08, -0.154309943, -7.74815145e-09, 0.988022506))
		Ub(CFrame.new(2215.97217, 19.3582382, -2482.66382, 0.984725893, -4.8232188e-08, 0.174111873, 3.5906762e-08, 1, 7.39402282e-08, -0.174111873, -6.65590676e-08, 0.984725893))
		Ub(CFrame.new(2279.09497, 19.5319271, -2566.47266, 0.923211098, 1.34089917e-09, -0.384293169, -1.34842226e-09, 1, 2.49863297e-10, 0.384293169, 2.87512902e-10, 0.923211098))
		Ub(CFrame.new(2291.23999, 19.7313976, -2586.60156, 0.837760448, 7.36023225e-08, -0.546037972, -8.74550352e-08, 1, 6.15250739e-10, 0.546037972, 4.72383377e-08, 0.837760448))
		Ub(CFrame.new(2279.09497, 19.5319271, -2566.47266, 0.923211098, 1.34089917e-09, -0.384293169, -1.34842226e-09, 1, 2.49863297e-10, 0.384293169, 2.87512902e-10, 0.923211098))
		Ub(CFrame.new(2215.97217, 19.3582382, -2482.66382, 0.984725893, -4.8232188e-08, 0.174111873, 3.5906762e-08, 1, 7.39402282e-08, -0.174111873, -6.65590676e-08, 0.984725893))
		Ub(CFrame.new(2216.5354, 19.3582458, -2470.72461, 0.988022506, -8.40341983e-08, 0.154309943, 8.18320629e-08, 1, 2.06226609e-08, -0.154309943, -7.74815145e-09, 0.988022506))
		Ub(CFrame.new(2286.67114, 19.1927166, -2080.41528, 0.999894977, 2.60326927e-10, 0.0144938128, -2.627637e-10, 1, 1.66221661e-10, -0.0144938128, -1.70012643e-10, 0.999894977))
end
...
function Pp()
    ...
    getgenv().teleport(CFrame.new(59.5785904, 21.3619766, 2338.87036))
    wait(1)
...
while wait(0.5) do
    if W.enabled then
        ...
        elseif game.Workspace.Trains:FindFirstChild("SteamEngine") and W.IncludePTrain == true then
            Pt()
        elseif Jb == true and W.IncludePower == true then
            Pp()
